...
def main() -> None:
    ...
    ap.add_argument("--out-missing-courses", default="missing_courses_graduate.csv", help="CSV for missing course codes.")
    ap.add_argument("--out-manual-blocks", default="manual_blocks_graduate.csv", help="CSV for manual/non-explicit blocks.")
